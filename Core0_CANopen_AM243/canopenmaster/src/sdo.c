...
UNS8 closeSDOtransfer (CO_Data* d, UNS8 nodeId, UNS8 whoami)
{
	...
	UNS8 line;
    UNS8 CliNbr;
	MSG_WAR(0x3A30, "closeSDOtransfer", 0);
...
UNS8 sendSDO (CO_Data* d, UNS8 whoami, UNS8 CliServNbr, UNS8 *pData)
{
	...
	if ( whoami == SDO_SERVER )	{
		...
		MSG_WAR(0x3A42, "offset+CliServNbr : ", offset+CliServNbr);
		MSG_WAR(0x3A43, "sub-index 1 : ", (UNS16) *((UNS32*) d->objdict[offset+CliServNbr].pSubindex[1].pObject));
		MSG_WAR(0x3A44, "sub-index 2 : ", (UNS16) *((UNS32*) d->objdict[offset+CliServNbr].pSubindex[2].pObject));
		MSG_WAR(0x3A45, "sub-index 3 : ", (UNS16) *((UNS32*) d->objdict[offset+CliServNbr].pSubindex[3].pObject));
	}
		...
		UNS32 * abortCode)
{
	...
	* abortCode = 0;
    ...
    if (d->transfers[line].state != SDO_FINISHED) {
		...
		MSG_ERR(0x1AF2, "SDO error : GetReadResultNetworkDict transfer not finished with node : ", nodeId);
