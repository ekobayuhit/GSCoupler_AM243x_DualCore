 ...
 * a CANopen module with LSS Slave capabilities by a CANopen module with LSS Master_ capabilities via the
 * CAN Network.
...
/** This function is called when the node is receiving a Master_ LSS message (cob-id = 0x7E5).
...
/** Used by the Master_ application to send a LSS command, WITHOUT response, to the slave. 
...
/** 
 * @ingroup lss
 * @brief Used by the Master_ application to send a LSS command, WITH response, to the slave. 
